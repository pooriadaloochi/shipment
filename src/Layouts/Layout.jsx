  ...
  const menu = (
    <Menu>
      <Menu.Item key="0" size="large">
        <Link to="/home" size="large">
          <SearchOutlined /> حمل و نقل
        </Link>
      </Menu.Item>
      <Menu.Item key="1">
        <Link to="/result">
  ...
  return (
    <LayoutAnt>
      <header className="haeder ant-layout-header">
        <div className="clean-header-row" data-test-id="not-authenticated">
          <div className="logo-wrapper">
            <Row className="haeder-logo screen-logo">
              <img
                      ...
                      <Link to="/result">
                        <Tooltip title="تغییر ارز">
                          <Dropdown
                            ...
                            size={['large']}
                          >
                            <Button hover="disable" shape="circle">
                              £
                            </Button>
                          </Dropdown>
                        </Tooltip>
